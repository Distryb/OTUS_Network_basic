...
!
```
Назначение всех неиспользуемых портов во VLAN 999 и их отключение  
```
...
Настройка интерфейса Fa0/5 на S1 с теми же параметрами транка
```
...
*- Порт на свиче будет в стостоянии Down, роутер будет недоступен, но транк между свичами ходить будет*
...
Не пинговался S2 с ПК_А, при проверке понял, что на S2 забыл прописать шлюз по умолчанию. После указания шлюза, пинг прошел:
![](Test_PC_A.png)  
